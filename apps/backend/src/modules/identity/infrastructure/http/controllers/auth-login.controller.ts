...
import { AuthLoginUseCase } from "@/modules/identity/application/usecases/auth-login.usecase";
...
export class AuthLoginController {
  static inject = [AuthLoginUseCase];

  constructor(private readonly loginUseCase: AuthLoginUseCase) {}
