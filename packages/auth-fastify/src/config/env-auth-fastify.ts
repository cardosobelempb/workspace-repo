...
export const envAuthFastifySchema = z.object({
...
export const envAuthFastify = createEnv(envAuthFastifySchema, { context: "auth" });
export const env = envAuthFastify;
export type EnvAuthFastify = z.infer<typeof envAuthFastifySchema>;
